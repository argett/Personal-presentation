...
var projectsInfo = {
  ...
  L2_BwarioKart: {
    ...
    description: "Projet réalisé en trinôme et codé en C. C'est un jeu de gestion où le joueur gère des karting louables. Il dispose sur une carte d'une ville de points d'emplacements vide sur lesquels le joueur peut créer des points de récupération de véhicule avec des places supplémentaires pour augmenter le nombre de karts ou des garages pour réparer ses véhicules. Le joueur peut également acheter de nouveaux véhicules, ordonner une réparation sur un véhicule précis et dispose de nombreuses améliorations afin que le véhicule dure plus longtemps, soit plus fiable, meilleur, etc. Le but du jeux étant de gagner le plus d'argent en augmentant le nombre de location. Notre jeux possède sa propre interface graphique, luncher, écran de fin...Le principae étant d'utiliser un maximum la structure de donnée 'Linked List' pour apprendre à manipuler un grands nombres de pointeurs et optimiser un code."
  },
